module.exports = function(grunt) {
    ...
    grunt.initConfig({
                ...
                files: [{
...

                    {
                        'build/menus.css': [
                            ...
                            'build/menus-flex.css',
                            'build/menus-tabs.css',
                    ...
                    {
                        'build/<%= nick %>-theme.css': [
                            'build/grids-skin.css',
                            'build/buttons-skin.css',
                            'build/forms-skin.css',
                            'build/menus-skin.css',
                            'build/tables-skin.css',
                            'build/app-skin.css'
                        ]
                    }
                ]
        ...
        replace: {
            colors: {
                src: ['build/*-theme.css'], // source files array (supports minimatch)
